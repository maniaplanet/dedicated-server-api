...
class OverviewTab extends \ManiaLive\Gui\Windowing\Controls\Tab
{
	...
	function beforeDraw()
	{
		...
		// database
		$text .= '$oNetwork$z'."\n";
		$text .= 'Total Bytes Sent: ' . round(Client_Gbx::$sent/1024) . "kb\n";
		$text .= 'Total Bytes Received: ' . round(Client_Gbx::$received/1024) . "kb\n";

		// graphical user interface
		$text .= '$oInterface Drawing$z'."\n";
		$text .= 'Avg Drawing Time: ' . round(GuiHandler::$avg_sendall * 1000) . " msec\n";
