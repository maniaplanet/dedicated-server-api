 ...
 *
 * $Id: TeamSpeak3.php 9/26/2011 7:06:29 scp@orilla $
 *
...
namespace ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3;
...
class TeamSpeak3
{
  ...
  const HOSTBANNER_IGNORE_ASPECT     = 0x01; //!< 1: adjust bug ignore aspect ratio
...
//    self::loadClass($adapter);
    ...
    if($object instanceof Adapter\ServerQuery)
    {
      ...
      if($node instanceof Node\Server)
      {
...
//    $path = str_replace('TeamSpeak3', dirname(__FILE__), $path);
    ...
    return APP_ROOT.DIRECTORY_SEPARATOR.'libraries'.DIRECTORY_SEPARATOR.str_replace('\\', DIRECTORY_SEPARATOR, $name);
  }
