 ...
 *
 * $Id: Abstract.php 9/26/2011 7:06:29 scp@orilla $
 *
...
abstract class AbstractTransport
{
  ...
  /**
   * Stores the \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Adapter\AbstractAdapter object using this transport.
   *
   * @var \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Adapter\AbstractAdapter
   */
  ...
  /**
   * Sets the \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Adapter\AbstractAdapter object using this transport.
   *
   * @param  \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Adapter\AbstractAdapter $adapter
   * @return void
   */
  public function setAdapter(\ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Adapter\AbstractAdapter $adapter)
  {
    $this->adapter = $adapter;
  }

  /**
   * Returns the \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Adapter\AbstractAdapter object using this transport.
   *
   * @return \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Adapter\AbstractAdapter
   */
  ...
  public function isReadyRead()
  {
	...
	return @stream_select($read, $null, $null, 0, 1000) == 1;
  }
}
