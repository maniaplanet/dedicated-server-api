 ...
 *
 * $Id: Channelgroup.php 9/26/2011 7:06:29 scp@orilla $
 *
...
class Channelgroup extends AbstractNode
{
  ...
  {
    return $this->getParent()->privilegeKeyCreate(\ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\TeamSpeak3::TOKEN_CHANNELGROUP, $this->getId(), $cid, $description, $customset);
  }
