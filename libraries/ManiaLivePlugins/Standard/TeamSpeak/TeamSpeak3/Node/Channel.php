 ...
 *
 * $Id: Channel.php 9/26/2011 7:06:29 scp@orilla $
 *
...
class Channel extends AbstractNode
{
  ...
  public function message($msg, $cpw = null)
  {
    ...
    $this->execute("sendtextmessage", array("msg" => $msg, "target" => $this->getId(), "targetmode" => \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\TeamSpeak3::TEXTMSG_CHANNEL));
  }
