 ...
 *
 * $Id: Servergroup.php 9/26/2011 7:06:29 scp@orilla $
 *
...
class Servergroup extends AbstractNode
{
  ...
  {
    return $this->getParent()->privilegeKeyCreate(\ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\TeamSpeak3::TOKEN_SERVERGROUP, $this->getId(), 0, $description, $customset);
  }
