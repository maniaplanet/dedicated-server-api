 ...
 *
 * $Id: Client.php 9/26/2011 7:06:29 scp@orilla $
 *
...
class Client extends AbstractNode
{
  ...
  {
    return new \ManiaLivePlugins\Standard\TeamSpeak\TeamSpeak3\Helper\String("/avatar_" . $this["client_base64HashClientUID"]);
  }
